...
import { installableCoreInstallBundleTargets } from "../export/core-install-bundle-targets.js";
import {
...
import { inspectFrameworkArtifactPlanInventory } from "../../framework-artifact-plan.js";
...
const DOCTOR_STATUS_FORMATTERS: Partial<Record<DoctorInventoryName, (item: InventoryItem) => string>> = {
  ...
  "framework-artifacts": (item) => doctorExportLabel(item, "export framework-artifacts"),
...
export function inspectStatusBundle(
  ...
  const inventory = [
    ...
    inspectFrameworkArtifactPlanInventory(paths, codexPaths),
