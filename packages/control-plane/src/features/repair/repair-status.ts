...
import { CORE_INSTALL_BUNDLE_TARGETS } from "../export/core-install-bundle-targets.js";
import { inspectStatusBundle } from "../../inventory.js";
import { inspectTelemetrySnapshot } from "../../preferences.js";
import { RTK_BINARY_INVENTORY_NAME } from "../status/rtk-binary.js";
import {
...
export function inspectRepairStatusFromStatusBundle(
  ...
  return {
    ...
    actionStatus: {
      ...
      uninstall_framework_artifacts: statusFor(statusBundle.inventory, "framework-artifacts"),
